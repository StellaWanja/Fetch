...
const Card = ({ user, albums }) => {
  ...
  return (
    <div className="flex flex-col gap-4 sm:flex-row justify-between shadow-md py-4 px-8 rounded my-8 cursor-pointer hover:bg-lightgray transition-colors ease-in delay-150">
      <div>
